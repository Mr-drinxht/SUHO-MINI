...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/JNKrR336oEE1UAXmFhqa6e',
    ADMIN_LIST_PATH: './admin.json',
    IMAGE_PATH: 'https://files.catbox.moe/s2f6pl.jpg',
    NEWSLETTER_JID: '120363420267586200@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: '',
    BOT_NAME: 'suho mini',
    OWNER_NAME: 'LORD SUNG',
    OWNER_NUMBER: 'https://files.catbox.moe/s2f6pl.jpg',
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> suho xᴅ ᴍɪɴɪ',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb6TAmjHwXb5Qx1BpE0j',
    BUTTON_IMAGES: {
        OWNER: 'https://files.catbox.moe/s2f6pl.jpg'
    }
};
...
const mongoUri = 'mongodb+srv://LordSung:Ste%40dy12@suhomini.zclj5yr.mongodb.net/';// add ur own mongodb url
...
function setupCommandHandlers(socket, number) {
    ...
    try {
        ...
        const title = '*💫suho xᴅ ᴍɪɴi*';
        const content = 
            `*© ʙʏ sung ᴛᴇᴄʜ*\n` +
            `*𝐁ᴏᴛ 𝐎ᴡɴᴇʀ :- lord sung*\n` +
            `*𝐎ᴡᴇɴʀ 𝐍ᴜᴍʙᴇʀ* :- +27649342626\n` +
            `*ᴍɪɴɪ ꜱɪᴛᴇ*\n> sᴏᴏɴ` +
        ...
        const buttons = [
            { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: 'suho mini ᴍᴇɴᴜ 📜' }, type: 1 },
            { buttonId: `${config.PREFIX}ping`, buttonText: { displayText: 'suho mini ᴘɪɴɢ 💥' }, type: 1 }
        ];
    ...
    break;
               ...
               case 'menu': {
                    ...
                    const content = '𓊈 SUHO MINI MD 𝐁𝐎𝐓 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒 𓊉\n' +
                   ...
                   '╰───────𓍯───────╯';                                    
                    ...
                    await socket.sendMessage(sender, {
                        ...
                        buttons: [
                            { buttonId: `${config.PREFIX}amenu`, buttonText: { displayText: 'suho mini ᴍᴀɪɴ ᴍᴇɴᴜ 🎛️' }, type: 1 },
                            { buttonId: `${config.PREFIX}bmenu`, buttonText: { displayText: 'suho mini ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ 📥' }, type: 1 },
                            { buttonId: `${config.PREFIX}cmenu`, buttonText: { displayText: 'suho mini ꜱᴘᴇᴄɪᴀʟ ᴍᴇɴᴜ 🧮' }, type: 1 },
                            { buttonId: `${config.PREFIX}dmenu`, buttonText: { displayText: 'suho mini ᴏᴛʜᴇʀ ᴍᴇɴᴜ 📄' }, type: 1 }
                        ],
                        },  { quoted: fakevCard });
...
╰━━━━━━━━━━━━━━━━━━━❖`;
    ...
    const buttonMessage = {
        image: { url: "https://files.catbox.moe/s2f6pl.jpg" },
        caption: Podda,
        footer: 'suho mini • Download Menu',
        buttons: buttons,
...
case 'song': {
  try {
    ...
    const caption = `🎶 *suho md ᴍɪɴɪ ʙᴏᴛ ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ* 🎧
